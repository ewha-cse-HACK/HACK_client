...
function PersonaSetting() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("서버 응답:", response.data); // null 이라 확인할 필요 없을 것 같긴함
    ...
    <SettingWrapper>
      ...
      <div id="targetElement">
        <form onSubmit={handleSubmit}>
          <div id="species">
            ...
            <div class="btn-container">
              <div class="btn-grid">
                ...
                <div class="button" id="bt3">
                  <img src="/images/bird.png" alt="새" />
                </div>
                <div class="button" id="bt4">
          ...
          <div id="charOne">
            <h4>같은 이름을 가진 동물들이 많아요!</h4>
            <h4>
              편지를 제대로 받을 수 있도록 반려동물에 대해 더 자세히 알려주세요!
            </h4>
            ...
            >
              <option value="notSelected">--선택안함--</option>
          ...
          <h4>
            이제 반려동물에 대해 당신이 기억하고 있는 걸 자유롭게 알려주세요.
          </h4>
          <h5>
